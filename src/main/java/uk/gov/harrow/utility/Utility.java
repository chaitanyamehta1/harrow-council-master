 ...
 */
//utility class extends base page class
public class Utility extends BasePage {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/gov/harrow/screenshot/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/gov/harrow/screenshot/" + screenshotName + dateName + ".png";
